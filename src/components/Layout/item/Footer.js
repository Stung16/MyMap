      ...
      <div className="flex  items-center justify-between gap-8 text-[#ffffffef]">
        ...
        <div>
          ...
          <div className="flex gap-6 p-2 mt-4 text-3xl rounded-md social-wrapper">
            <span>
              <i className="text-white cursor-pointer fa-brands fa-facebook"></i>
            </span>
            <span>
              <i className="text-white cursor-pointer fa-brands fa-twitter"></i>
            </span>
            <span>
              <i className="text-white cursor-pointer fa-brands fa-linkedin-in"></i>
            </span>
            <span>
              <i className="text-white cursor-pointer fa-brands fa-instagram"></i>
            </span>
            <span>
              <i className="text-white cursor-pointer fa-brands fa-youtube"></i>
            </span>
            <span>
              <i className="text-white cursor-pointer fa-brands fa-dribbble"></i>
            </span>
